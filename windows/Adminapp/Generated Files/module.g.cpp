...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"Adminapp.MainPage"))
    {
        return winrt_make_Adminapp_MainPage();
    }

    if (requal(name, L"Adminapp.XamlMetaDataProvider"))
    {
        return winrt_make_Adminapp_XamlMetaDataProvider();
    }
