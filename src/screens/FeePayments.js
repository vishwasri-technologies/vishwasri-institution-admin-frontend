...
//     setStudents(prev =>
//       prev.map((s, i) =>
//         i === index ? { ...s, isEditing: !s.isEditing, paidInput: s.Paidamount.toString() } : s
//       )
//     );
//   };
...
//             ...s,
//             Paidamount: newPaid,
//             Pendingamount: s.totalFee - newPaid,
//             isEditing: false,
//           };
//         }
//         return s;
...
//   const updatePaidInput = (index, value) => {
//     setStudents(prev =>
//       prev.map((s, i) => (i === index ? { ...s, paidInput: value } : s))
//     );
//   };
...
//                 <>
//                   <TextInput
//                     style={[styles.cell, { backgroundColor: '#fff', borderWidth: 1, borderColor: '#ccc' }]}
//                     value={student.paidInput}
//                     onChangeText={(val) => updatePaidInput(idx, val)}
//                     keyboardType="numeric"
//                   />
//                   <Text style={styles.cell}>{student.totalFee - parseInt(student.paidInput || '0')}</Text>
